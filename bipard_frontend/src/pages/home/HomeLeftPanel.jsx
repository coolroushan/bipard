...
export default function HomeLeftPanel() {
  ...
  const [isSyllabusModalOpen, setIsSyllabusModalOpen] =
    useState(false);
    ...
    <>
      ...
      <aside className="portal-left-panel flex flex-col items-center w-full md:w-[45%] lg:w-[520px] xl:w-[560px] min-h-full overflow-hidden shrink-0 rounded-t-none md:rounded-tr-none md:rounded-l-none">
        ...
        >
          ...
          <path
            d="M100,0 C35,25 75,75 15,100 L100,100 Z"
            fill="#E3AD54"
          />
          ...
          <path
            d="M100,0 C45,25 85,75 25,100 L100,100 Z"
            fill="#ffffff"
          />
        </svg>
            ...
            {features.map((item, index) => {
              ...
              return (
                <div
                  ...
                  className={`flex flex-col items-center justify-center bg-white opacity-90 rounded-none shadow-[0_8px_24px_-6px_rgba(0,0,0,0.3)] transition-transform duration-200 hover:-translate-y-1 relative overflow-hidden cursor-pointer`}
                  style={{
                    width: "95px",
                    height: "125px",
                  }}
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm transition-opacity">
          ...
          <div className="bg-white w-full max-w-[650px] rounded shadow-xl overflow-hidden">
            ...
            <div className="flex justify-between items-center px-5 py-4 border-b border-gray-200">
              ...
              <h3 className="text-[20px] font-semibold text-gray-800 tracking-wide">
                Gazette List
              </h3>
