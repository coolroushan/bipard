...
const questions = [
  ...
  {
    id: 7,
    question: "Which shortcut is commonly used to save a document?",
    options: [
      "Ctrl + S",
      "Ctrl + D",
      "Ctrl + F",
  ...
  {
    id: 9,
    question: "Which application is primarily used for creating and editing documents?",
    options: [
      "Microsoft Word",
      "Calculator",
      "Paint",
  ...
  {
    id: 10,
    question: "Which application is commonly used to create spreadsheets?",
    options: [
      "Microsoft Word",
      "Microsoft Excel",
      "Notepad",
  ...
  {
    id: 11,
    question: "What is the extension of a modern Microsoft Word document?",
    options: [
      ".xlsx",
      ".pptx",
      ".docx",
  ...
  {
    id: 12,
    question: "What is the extension commonly associated with Microsoft Excel workbooks?",
    options: [
      ".xlsx",
      ".docx",
      ".txt",
  ...
  {
    id: 13,
    question: "Which software is commonly used for making presentations?",
    options: [
      "Microsoft Excel",
  ...
  {
    id: 19,
    question: "Which device is used to produce a hard copy of a document?",
    options: [
      "Scanner",
      "Printer",
      "Keyboard",
  ...
  {
    id: 20,
    question: "Which device is commonly used to scan a physical document?",
    options: [
      "Printer",
      "Scanner",
      "Speaker",
  ...
  {
    id: 21,
    question: "Which shortcut is commonly used to select all content?",
    options: [
      "Ctrl + A",
      "Ctrl + E",
      "Ctrl + L",
  ...
  {
    id: 23,
    question: "Which component temporarily stores data being actively used by the computer?",
    options: [
      "RAM",
      "Printer",
      "Monitor",
...
const Test = () => {
  ...
  const markedCount =
    Object.values(markedQuestions).filter(Boolean)
      .length;
        ...
        <div className="mx-auto max-w-[1600px] px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#126df3] text-white shadow-sm">
              ...
              <div className="min-w-0">
                ...
                <h1 className="truncate text-sm font-bold text-[#172b40] sm:text-base">
                  Computer Competency Test
                </h1>

                <p className="hidden text-xs text-gray-500 sm:block">
                  Computer Competency Test Examination
                </p>
            ...
            <div className="hidden flex-1 justify-center lg:flex">
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-bold text-[#126df3]">
                  {currentQuestion + 1} /{" "}
                  {totalQuestions}
                </p>
            ...
            <div
              className={`flex shrink-0 items-center gap-2 rounded-lg border px-3 py-2 ${
                timeLeft <= 300
                  ...
                  : "border-[#dce5ef] bg-[#f5f8fc] text-[#263746]"
              }`}
            >
              ...
              <div>
                <p className="hidden text-[10px] font-medium uppercase sm:block">
                  Time Left
                </p>
          ...
          <div className="mt-3 h-1.5 overflow-hidden rounded-full bg-[#e6ebf0]">
            ...
            <div
              className="h-full rounded-full bg-[#126df3] transition-all duration-300"
              style={{
                width: `${progress}%`,
              }}
            />
        ...
        <div className="mx-auto max-w-[1600px] px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#e6f0ff] text-sm font-bold text-[#126df3]">
                C
              </div>
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <div>
                  ...
                  <div className="mb-1 flex items-center gap-2">
                    ...
                    <span className="rounded-md bg-[#126df3] px-2.5 py-1 text-xs font-bold text-white">
                      Q{currentQuestion + 1}
                    </span>
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm font-semibold text-[#126df3]">
                  ...
                  (option, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`group flex w-full items-center gap-3 rounded-lg border p-4 text-left transition ${
                          selected
                            ? "border-[#126df3] bg-[#eef5ff] shadow-sm"
                            : "border-[#dce2e8] bg-white hover:border-[#9bbde9] hover:bg-[#f8fbff]"
                        }`}
                      >
                        ...
                        <span
                          className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-full border text-sm font-semibold transition ${
                            selected
                              ? "border-[#126df3] bg-[#126df3] text-white"
                              : "border-[#cfd8e2] bg-[#f8f9fa] text-gray-600 group-hover:border-[#126df3] group-hover:text-[#126df3]"
                          }`}
                        >
                          {String.fromCharCode(
                            65 + index
                        ...
                        <span
                          className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-full border ${
                            selected
                              ? "border-[#126df3] bg-[#126df3] text-xs text-white"
                              : "border-[#cfd8e2]"
                          }`}
                        >
                          {selected && "✓"}
                  ...
                  <button
                    ...
                    className={`rounded-md border px-4 py-2.5 text-sm font-medium transition ${
                      markedQuestions[
                        ...
                        : "border-[#d5dce3] bg-white text-gray-600 hover:bg-gray-50"
                    }`}
                  >
                    {markedQuestions[question.id]
                      ? "Unmark Question"
              ...
              <div className="mt-6 flex flex-col gap-3 border-t border-[#e4e8ec] pt-5 sm:flex-row sm:justify-between">
                ...
                totalQuestions - 1 ? (
                  <button
                    ...
                    className="flex min-h-11 items-center justify-center gap-2 rounded-md bg-[#126df3] px-6 text-sm font-semibold text-white shadow-sm transition hover:bg-[#095bcf] hover:shadow-md"
                  >
                    Submit Test
                    <span>✓</span>
                  </button>
          ...
          <aside className="h-fit lg:sticky lg:top-[145px]">
            ...
            <section className="overflow-hidden rounded-xl border border-[#d8dee5] bg-white shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-2 border-b border-[#e4e8ec] p-4">
                ...
                <Legend
                  label="Current"
                  className="ring-2 ring-[#126df3] ring-offset-1"
                />
                    ...
                    (item, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={`relative flex h-10 items-center justify-center rounded-md border text-xs font-semibold transition ${
                            current
                              ? "border-[#126df3] bg-[#126df3] text-white shadow-sm ring-2 ring-[#126df3]/20"
                              : marked
                              ? "border-amber-300 bg-amber-400 text-white"
                              : answered
                              ? "border-[#126df3] bg-[#eaf2ff] text-[#126df3]"
                              : "border-[#d6dde4] bg-[#f7f9fb] text-gray-600 hover:border-[#126df3] hover:text-[#126df3]"
                          }`}
                        >
                          {index + 1}
                          ...
                          {answered &&
                            !current && (
                              <span className="absolute -right-1 -top-1 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-[#126df3] text-[8px] text-white">
                                ✓
                              </span>
                            )}
                        </button>
              ...
              <div className="border-t border-[#e4e8ec] bg-[#fafbfc] p-4">
                ...
                <div className="grid grid-cols-3 gap-2 text-center">
                  ...
                  <div>
                    <p className="text-lg font-bold text-[#126df3]">
                      {answeredCount}
                    </p>
            ...
            <div className="mt-4 rounded-xl border border-red-100 bg-red-50 p-4">
              ...
              <p className="mt-1 text-xs leading-5 text-red-600">
                Please review unanswered and marked
...
const StatusBadge = ({
  ...
  const styles = {
    answered:
      "border-blue-100 bg-blue-50 text-[#126df3]",
    unanswered:
  ...
  return (
    <div
      className={`flex items-center gap-2 rounded-md border px-3 py-1.5 text-xs font-medium ${styles[type]}`}
    >
      <span>{label}</span>
      ...
      <div className="w-full max-w-md overflow-hidden rounded-xl bg-white shadow-2xl">
        ...
        <div className="border-b border-[#e2e7ec] bg-[#f8f9fa] px-5 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h3 className="text-base font-semibold text-[#172b40]">
                Submit Test?
              </h3>
        ...
        <div className="p-5">
          ...
          <p className="text-sm leading-6 text-gray-600">
            Once you submit the test, you will not
        ...
        <div className="flex flex-col-reverse gap-3 border-t border-[#e2e7ec] bg-[#fafbfc] p-4 sm:flex-row sm:justify-end">
          ...
          <button
            type="button"
            onClick={onCancel}
            className="rounded-md border border-[#d2dae2] bg-white px-5 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50"
          >
            Cancel
          </button>
          ...
          <button
            type="button"
            onClick={onConfirm}
            className="rounded-md bg-[#126df3] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#095bcf]"
          >
            Confirm & Submit
          </button>
...
const SummaryBox = ({
  ...
  return (
    <div
      className={`rounded-lg p-3 text-center ${styles[type]}`}
    >
      ...
      <header className="border-b border-[#d8dee5] bg-white shadow-sm">
        ...
        <div className="mx-auto max-w-[1200px] px-4 py-4 sm:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#126df3] text-white">
              ▣
            </div>

            <div>

              <h1 className="text-base font-bold text-[#172b40]">
                Computer Competency Test
              </h1>
      ...
      <main className="mx-auto max-w-[1000px] px-4 py-8 sm:px-6 lg:py-12">
        ...
        <section className="overflow-hidden rounded-xl border border-[#d8dee5] bg-white shadow-md">
          ...
          <div className="border-b border-[#e1e5e9] bg-[#f8f9fa] px-5 py-8 text-center">
            ...
            <h2 className="mt-4 text-2xl font-bold text-[#172b40]">
          ...
          <div className="p-5 sm:p-8">
            ...
            <div className="mx-auto max-w-xl text-center">
              ...
              <div className="mt-2 text-5xl font-bold text-[#126df3]">
                {result.correct}
            ...
            <div className="mt-6 rounded-lg border border-[#dce3ea] bg-[#fafbfc] p-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-bold text-[#126df3]">
              ...
              <div className="mt-3 h-2 overflow-hidden rounded-full bg-[#e4e9ee]">
                ...
                <div
                  className="h-full rounded-full bg-[#126df3]"
                  style={{
            ...
            <button
              type="button"
              onClick={onRestart}
              className="mx-auto mt-7 flex min-h-11 items-center justify-center rounded-md bg-[#126df3] px-6 text-sm font-semibold text-white shadow-sm transition hover:bg-[#095bcf]"
            >
              Return to Test
            </button>
...
const ResultStat = ({
  ...
  return (
    <div
      className={`rounded-lg border p-4 text-center ${styles[type]}`}
    >
