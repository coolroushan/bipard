  ...
  const handleLogin = (e) => {
    ...
    try {
      ...
      try {
        ...
        console.error("registeredUsers JSON parse error:", parseError);
        registeredUsers = [];
      }
      ...
      if (!Array.isArray(registeredUsers) || registeredUsers.length === 0) {
        setError("No registered candidate found. Please register first.");
        setLoading(false);
        return;
      }
      ...
      // FORMAT DOB
      //
      // Registration saves DOB as: DD-MM-YYYY
      // Login input gives: YYYY-MM-DD
      // =================================================
      ...
      const user = registeredUsers.find((item) => {
        ...
        const registeredAadhaar = String(item.aadhaar ?? "").trim();
        const registeredDOB = String(item.dob ?? "").trim();
        const enteredAadhaar = String(aadhaar).trim();
        const enteredDOB = String(formattedDOB).trim();

        return (
          registeredAadhaar === enteredAadhaar &&
          registeredDOB === enteredDOB
        );
      });
        ...
        <div className="w-full md:flex-1 bg-white flex flex-col px-6 py-10 lg:px-14 relative z-10 shrink-0">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              >
                <span className="text-[#EF4444] mr-1 text-[16px]">*</span>
                Aadhaar Number / आधार संख्या
              </label>

              <div
                className={`flex items-center border rounded-[8px] overflow-hidden h-[55px] bg-white ${
              ...
              >
                <div className="w-[55px] h-full bg-[#f8fafc] flex items-center justify-center border-r border-gray-200 shrink-0">
                  <CreditCard className="text-[#06366F]/60" size={22} />
                </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center border border-gray-300 rounded-[8px] overflow-hidden h-[55px] bg-white">
                <div className="w-[55px] h-full bg-[#f8fafc] flex items-center justify-center border-r border-gray-200 shrink-0">
                  <CalendarDays className="text-[#06366F]/60" size={22} />
                </div>
            ...
            <div className="flex flex-col">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  >
                    {captcha && <span className="text-white font-bold">✓</span>}
                  </div>
            ...
            <div className="mt-2 flex flex-col gap-6">
              ...
              >
                ...
                {!loading && <LogIn size={20} strokeWidth={2.5} />}
              </button>
